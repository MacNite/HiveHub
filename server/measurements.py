...
MEASUREMENT_SELECT_COLUMNS = """
    ...
    -- writes them. The columns and rows stay so readings recorded during the
    -- wired era remain retrievable; every row written since is simply NULL here.
