...
- [docs/ruuvitag-ble-sensor.md](docs/ruuvitag-ble-sensor.md) — optional RuuviTag in-hive BLE sensor (temp/humidity/pressure/acceleration) on the same scan bridge.
